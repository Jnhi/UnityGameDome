            ...
            try
            {
            ...
            
                {
                    ...
                    
                    {
                        ...
                        FairyGUI.Utils.XMLIterator.Begin (arg0, false);
            ...
            try
            {
            ...
            
                {
                    ...
                    
                    {
                        ...
                        var result = FairyGUI.Utils.XMLIterator.GetRawText (false);
            ...
            try
            {
            ...
            
                {
                    ...
                    
                    {
                        ...
                        var result = FairyGUI.Utils.XMLIterator.GetText (false);
        ...
        private static void F_GetAttributes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.Dictionary<string, string>), false, false, v8Value0, ref argobj0, ref argType0))
                    ...
                    if (ArgHelper.IsMatch((int)data, isolate, Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Hashtable), false, false, v8Value0, ref argobj0, ref argType0))
    ...
    // ==================== properties start ====================
        ...
        private static void S_tagType(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                FairyGUI.Utils.XMLTagType arg0 = (FairyGUI.Utils.XMLTagType)StaticTranslate<int>.Get((int)data, isolate, Puerts.NativeValueApi.GetValueFromArgument, v8Value0, false);
