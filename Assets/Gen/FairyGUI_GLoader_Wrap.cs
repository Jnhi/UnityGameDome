...
namespace PuertsStaticWrap
{
    ...
    // ==================== methods start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_onExternalLoadSuccess(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GLoader;
        ...
        
                {
                    ...
                    
                    {
                        ...
                        obj.onExternalLoadSuccess (arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_onExternalLoadFailed(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GLoader;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "onExternalLoadSuccess", IsStatic = false}, M_onExternalLoadSuccess },
                    { new Puerts.MethodKey { Name = "onExternalLoadFailed", IsStatic = false}, M_onExternalLoadFailed },
