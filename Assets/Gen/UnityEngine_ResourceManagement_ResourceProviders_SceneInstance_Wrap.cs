...
{
    public static class UnityEngine_ResourceManagement_ResourceProviders_SceneInstance_Wrap 
    {
            ...
            try
            {
            ...
            
                {
...

                    {
                        ...
                        var result = new UnityEngine.ResourceManagement.ResourceProviders.SceneInstance();

                    

                    
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ResourceManagement.ResourceProviders.SceneInstance), result);
    ...
    // ==================== methods start ====================
        ...
        private static void M_ActivateAsync(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ResourceManagement.ResourceProviders.SceneInstance)Puerts.Utils.GetSelf((int)data, self);
    ...
    // ==================== events end ====================
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    { new Puerts.MethodKey { Name = "ActivateAsync", IsStatic = false}, M_ActivateAsync },
