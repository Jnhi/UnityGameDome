...
namespace PuertsStaticWrap
{
    public static class FairyGUI_GoWrapper_Wrap 
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to " + typeof(FairyGUI.GoWrapper).GetFriendlyName() + " constructor");
    ...
    // ==================== properties start ====================
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_customCloneMaterials(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GoWrapper;
                var result = obj.customCloneMaterials;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_customCloneMaterials(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GoWrapper;
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                argobj0 = argobj0 != null ? argobj0 : StaticTranslate<System.Action<System.Collections.Generic.Dictionary<UnityEngine.Material, UnityEngine.Material>>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); System.Action<System.Collections.Generic.Dictionary<UnityEngine.Material, UnityEngine.Material>> arg0 = (System.Action<System.Collections.Generic.Dictionary<UnityEngine.Material, UnityEngine.Material>>)argobj0;
                obj.customCloneMaterials = arg0;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_customRecoverMaterials(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GoWrapper;
                var result = obj.customRecoverMaterials;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_customRecoverMaterials(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GoWrapper;
                ...
                obj.customRecoverMaterials = arg0;
    ...
    // ==================== events start ====================
        ...
        private static void A_onUpdate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                IntPtr v8Value0 = PuertsDLL.GetArgumentValue(info, 0);
                object argobj0 = null;
                argobj0 = argobj0 != null ? argobj0 : StaticTranslate<System.Action<FairyGUI.UpdateContext>>.Get((int)data, isolate, NativeValueApi.GetValueFromArgument, v8Value0, false); System.Action<FairyGUI.UpdateContext> arg0 = (System.Action<FairyGUI.UpdateContext>)argobj0;
                obj.onUpdate += arg0;
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"customCloneMaterials", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_customCloneMaterials, Setter = S_customCloneMaterials} },

                    {"customRecoverMaterials", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_customRecoverMaterials, Setter = S_customRecoverMaterials} }
                },
