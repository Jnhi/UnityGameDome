...
namespace PuertsStaticWrap
{
    public static class AutoStaticCodeRegister
    {
        ...
        {
            jsEnv.AddLazyStaticWrapLoader(typeof(AudioManager), AudioManager_Wrap.GetRegisterInfo);
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(GameLaunch), GameLaunch_Wrap.GetRegisterInfo);
