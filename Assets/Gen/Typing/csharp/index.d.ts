    ...
    namespace UnityEngine {
        ...
        */
        ...
        class AudioManager extends MonoSingleton$1<AudioManager>
        {
            protected [__keep_incompatibility]: never;
            public bgmVol : number
            public musicVol : number
            public soundList : System.Collections.Generic.List$1<AudioPoolData>
            public Init () : void
            public Start () : void
            public Update () : void
            public Play ($musicPath: string, $isLoop?: boolean, $cb?: System.Action) : AudioPoolData
            public Pause ($apData: AudioPoolData) : AudioPoolData
            public Resume ($apData: AudioPoolData) : AudioPoolData
            public StopMusic ($apData: AudioPoolData) : void
    ...
    namespace NiceTS {
        ...
        { 
        (channel: NiceTS.TChannel, code: number) : void; 
        Invoke?: (channel: NiceTS.TChannel, code: number) => void;
        }
        var ErrorCallback: { new (func: (channel: NiceTS.TChannel, code: number) => void): ErrorCallback; }
        interface ReadCallback
        { 
        (arrayBuffer: ArrayBuffer) : void; 
        Invoke?: (arrayBuffer: ArrayBuffer) => void;
        }
        ...
        class ResourceManager extends System.Object
        {
            ...
            public static LoadFairyGUIPackage ($address: string, $packageName: string) : $Task<any>
